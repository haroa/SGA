...
void cCamera::Setup(LPDIRECT3DDEVICE9& pD3DDevice)
{
	RECT rc;
...
void cCamera::Update(LPDIRECT3DDEVICE9& pD3DDevice, D3DXVECTOR3* pTarget)
{
	...
	D3DXMatrixLookAtLH(&matView, &m_vEye, pTarget
		, &D3DXVECTOR3(0, 1, 0));
