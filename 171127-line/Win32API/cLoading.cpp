...
void cLoadItem::InitForEmpty(string key, int width, int height, bool isTrans, COLORREF transColor)
{
	m_eKind = LOAD_KIND_EMPTY_MAGENTA;
...
void cLoading::LoadEmpty(string key, int width, int height, bool isTrans, COLORREF transColor)
{
	cLoadItem* item = new cLoadItem;
	item->InitForEmpty(key, width, height,isTrans,transColor);
