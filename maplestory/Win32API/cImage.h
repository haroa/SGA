...
public:
	...
	void Render(HDC hdc, int destX, int destY, int sizeX, int sizeY, int width);
	void ProgressRender(HDC hdc, int destX, int destY, int sourX, int sourY, int sourWidth);
	...
	void FrameRendersize(HDC hdc, int destX, int destY, int width, int height);
	void FrameRender(HDC hdc, int destX, int destY, int sourX, int sourY, int FrameWidth);
	void ProgressBarFrameRender(HDC hdc, int destX, int destY, int sourX, int sourY, int FrameWidth, int FrameHeight);
	void FrameRender(HDC hdc, int destX, int destY,
	...
	//이미지의 가로 세로 셋터
	//void SetWidth(int width) { m_pImageInfo->nFrameWidth = width; }
	//void SetHeight(int height) { m_pImageInfo->nFrameHeight = height; }
	...
	void ViewPortRender(HDC hdc, RECT ViewPort, int x, int y);
};
